...
def generate_massive_suite():
    output_path = "testsprite_tests/massive_2500_campaign.py"
    ...
    print(f"Successfully generated {output_path} with 2,500 'hard' test cases.")

if __name__ == "__main__":
    generate_massive_suite()
